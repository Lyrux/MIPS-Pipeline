...
*/
module alu(
    input wire [31:0] a, // source from register (rs)
    input wire [31:0] b, // target from register (rt)
    ...
    case(control)
        ...
        ALUslt: result = a < b ? 1 - sign_mismatch : 0 + sign_mismatch; // a < b ? result = 1 : result = 0
...
// aluop = 2'b11 which sets control = ALUx = 3'b011 and ALU output is 32 x's